...
INSERT INTO `tb_categoria` VALUES (1,'Informática'),(2,'Escritorio');
...
INSERT INTO `tb_cliente` VALUES (1,'36378912377','maria@gmail.com','Maria da Silva',1),(2,'39044683756','joao@gmail.com','João da Silva',1),(3,'17491206824','fabio@gmail.com','Fabio Guimaraes',1);
...
INSERT INTO `tb_endereco` VALUES (1,'Jardim','38220834','Apto 203','Rua Flores','300',1,1),(2,'Centro','38777012','Sala 800','Avenida Matos','105',2,1),(3,NULL,'38746928','Apto 302','Rua das Acácias','345',2,2),(4,NULL,'38746928','Apto 302','Rua das Acácias','345',2,3);
...
CREATE TABLE `tb_item_pedido` (
  ...
  KEY `FK7vkkyy2auypwoiiouck1qu2bd` (`id_produto`),
  CONSTRAINT `FK7vkkyy2auypwoiiouck1qu2bd` FOREIGN KEY (`id_produto`) REFERENCES `tb_produto` (`id`),
  CONSTRAINT `FK9hmxwx5o13b45x76qiwcdfwcj` FOREIGN KEY (`id_pedido`) REFERENCES `tb_pedido` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_item_pedido` VALUES (0,2000,1,1,1),(0,80,2,3,1),(100,800,1,2,2),(0,2000,1,1,3),(0,80,2,3,3);
...
INSERT INTO `tb_pedido` VALUES (1,'2017-09-30 13:32:00',1,1),(2,'2017-10-10 22:35:00',1,2),(3,'2020-03-17 17:34:00',1,1);
...
INSERT INTO `tb_telefones` VALUES (1,'27363323'),(1,'93838393'),(2,'32547698'),(2,'997723874'),(3,'32547698'),(3,'997723874');
...
-- Dump completed on 2020-03-17 15:00:45
